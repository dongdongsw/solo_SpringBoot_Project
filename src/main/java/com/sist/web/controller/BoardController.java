...
public class BoardController {
	...
	public String board_insert_ok(@ModelAttribute("vo") BoardEntity vo,Model model) {
	...
	public String board_delete_ok(@RequestParam("pwd") String pwd, @RequestParam("no") int no, Model model) {
